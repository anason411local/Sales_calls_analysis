...
df_importance = pd.read_csv(f'analysis_outputs/{AGENT_TYPE}/03_importance_combined.csv')
df_corr_target = pd.read_csv(f'analysis_outputs/{AGENT_TYPE}/02_correlation_with_target.csv')
df_stats_num = pd.read_csv(f'analysis_outputs/{AGENT_TYPE}/04_statistical_tests_numerical.csv')
df_stats_cat = pd.read_csv(f'analysis_outputs/{AGENT_TYPE}/04_statistical_tests_categorical.csv')
...
try:
    df_lime = pd.read_csv(f'analysis_outputs/{AGENT_TYPE}/05b_lime_importance.csv')
    has_lime = True
...
plt.tight_layout()
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/viz_06_top_20_variables.png',
...
plt.tight_layout()
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/viz_06_section_analysis.png',
            dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/viz_06_correlation_vs_importance.png',
            dpi=300, bbox_inches='tight')
...
try:
    plt.savefig(f'analysis_outputs/{AGENT_TYPE}/viz_06_effect_sizes.png',
                dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/viz_06_model_comparison.png',
            dpi=300, bbox_inches='tight')
