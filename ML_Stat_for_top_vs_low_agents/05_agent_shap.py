...
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/shap_05_rf_summary_beeswarm.png', 
...
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/shap_05_rf_importance_bar.png',
            dpi=300, bbox_inches='tight')
...
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/shap_05_rf_waterfall.png',
            dpi=300, bbox_inches='tight')
...
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/shap_05_rf_dependence.png',
            dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.subplots_adjust(bottom=0.12, left=0.25)  # More space for labels on LEFT
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/shap_05_xgb_summary_beeswarm.png',
            dpi=300, bbox_inches='tight')
...
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/shap_05_xgb_importance_bar.png',
            dpi=300, bbox_inches='tight')
...
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/shap_05_xgb_waterfall.png',
            dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.subplots_adjust(bottom=0.08, top=0.94)
plt.savefig(f'analysis_outputs/{AGENT_TYPE}/shap_05_xgb_dependence.png',
            dpi=300, bbox_inches='tight')
...
shap_importance.to_csv(f'analysis_outputs/{AGENT_TYPE}/05_shap_importance.csv', index=False)
