...
plt.tight_layout()
plt.savefig('analysis_outputs/level1_variable/lime_05b_rf_individual_explanations.png',
...
plt.suptitle('LEVEL 1: LIME EXPLANATIONS FOR KEY PREDICTIONS (Gradient Boosting)\n' +
             ...
             fontsize=14, fontweight='bold', y=0.995)
plt.tight_layout()
plt.savefig('analysis_outputs/level1_variable/lime_05b_gb_individual_explanations.png',
            dpi=300, bbox_inches='tight')
...
# Save
df_lime_importance.to_csv('analysis_outputs/level1_variable/05b_lime_importance.csv', index=False)
...
plt.tight_layout()
plt.savefig('analysis_outputs/level1_variable/lime_05b_aggregated_importance.png',
            dpi=300, bbox_inches='tight')
...
try:
    ...
    plt.tight_layout()
    plt.savefig('analysis_outputs/level1_variable/lime_05b_lime_vs_shap.png',
                dpi=300, bbox_inches='tight')
...
import json
with open('analysis_outputs/level1_variable/05b_lime_summary.json', 'w') as f:
